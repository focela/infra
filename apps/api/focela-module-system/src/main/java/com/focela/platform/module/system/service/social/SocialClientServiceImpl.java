...
import static com.focela.platform.framework.common.utils.collection.MapUtils.findAndThen;
import static com.focela.platform.framework.common.utils.date.LocalDateTimeUtils.UTC_MS_WITH_XXX_OFFSET_FORMATTER;
import static com.focela.platform.framework.common.utils.date.LocalDateTimeUtils.toEpochSecond;
...
public class SocialClientServiceImpl implements SocialClientService {
     ...
     * 3. developer：开发版
     */
    @Value("${focela.wxa-code.env-version:release}")
     ...
     * 3. formal：正式版
     */
    @Value("${focela.wxa-subscribe-message.miniprogram-state:formal}")
