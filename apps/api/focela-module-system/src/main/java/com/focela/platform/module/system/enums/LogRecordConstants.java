package com.focela.platform.module.system.enums;
...
public interface LogRecordConstants {
    ...
    String SYSTEM_USER_UPDATE_SUCCESS = "更新了用户【{{#user.nickname}}】: {_DIFF{#updateRequest}}";
    ...
    String SYSTEM_ROLE_UPDATE_SUCCESS = "更新了角色【{{#role.name}}】: {_DIFF{#updateRequest}}";
