...
/**
 * {@link DefaultSocialClientService} 的单元测试类
 *
 * @author 芋道源码
 */
@Import(DefaultSocialClientService.class)
public class DefaultSocialClientServiceTest extends BaseDbUnitTest {

    @Resource
    private DefaultSocialClientService socialClientService;
