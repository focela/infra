...
@Import(DictionaryTypeServiceImpl.class)
public class DictionaryTypeServiceImplTest extends BaseDbUnitTest {

    @Resource
    private DictionaryTypeServiceImpl dictTypeService;
