...
@Import(DictionaryDataServiceImpl.class)
public class DictionaryDataServiceImplTest extends BaseDbUnitTest {

    @Resource
    private DictionaryDataServiceImpl dictDataService;
