...
CREATE TABLE IF NOT EXISTS "system_post" (
    ...
    "tenant_id" bigint not null default  '0',
    PRIMARY KEY ("id")
) COMMENT 'Post information table';
...
CREATE TABLE IF NOT EXISTS `system_user_post`(
    ...
    "tenant_id"   bigint    not null default '0',
    PRIMARY KEY (`id`)
) COMMENT ='User-post table';

CREATE TABLE IF NOT EXISTS "system_notice" (
	"id" bigint NOT NULL GENERATED BY DEFAULT AS IDENTITY,
	"title" varchar(50) NOT NULL COMMENT 'Notice title',
	"content" text NOT NULL COMMENT 'Notice content',
	"type" tinyint NOT NULL COMMENT 'Notice type (1 notification, 2 notice)',
	"status" tinyint NOT NULL DEFAULT '0' COMMENT 'Notice status (0 normal, 1 closed)',
	"creator" varchar(64) DEFAULT '' COMMENT 'Creator',
	"create_time" datetime NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT 'Create time',
	"updater" varchar(64) DEFAULT '' COMMENT 'Updater',
	"update_time" datetime NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT 'Update time',
	"deleted" bit NOT NULL DEFAULT 0 COMMENT 'Whether deleted',
    "tenant_id" bigint not null default  '0',
    PRIMARY KEY("id")
) COMMENT 'Notification and notice table';
...
CREATE TABLE IF NOT EXISTS "system_oauth2_code" (
     ...
     "deleted" bit NOT NULL DEFAULT FALSE,
     PRIMARY KEY ("id")
) COMMENT 'OAuth2 authorization code';
...
CREATE TABLE IF NOT EXISTS "system_notify_template" (
    ...
    "deleted" bit NOT NULL DEFAULT FALSE,
    PRIMARY KEY ("id")
) COMMENT 'In-site message template table';
