...
import com.focela.platform.system.controller.admin.social.request.user.SocialUserBindRequest;
import com.focela.platform.system.controller.admin.social.request.user.SocialUserPageRequest;
import com.focela.platform.system.controller.admin.social.response.user.SocialUserResponse;
import com.focela.platform.system.controller.admin.social.request.user.SocialUserUnbindRequest;
...
public class SocialUserController {
    ...
    @PreAuthorize("@ss.hasPermission('system:social-user:query')")
    public CommonResult<PageResult<SocialUserResponse>> getSocialUserPage(@Valid SocialUserPageRequest pageRequest) {
        PageResult<SocialUserEntity> pageResult = socialUserService.getSocialUserPage(pageRequest);
