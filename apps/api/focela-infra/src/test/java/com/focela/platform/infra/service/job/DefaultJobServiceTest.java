...
import com.focela.platform.infra.controller.admin.job.request.JobPageRequest;
import com.focela.platform.infra.controller.admin.job.request.JobSaveRequest;
...
public class DefaultJobServiceTest extends BaseDbUnitTest {
    ...
    public void testCreateJob_cronExpressionValid() {
        ...
        assertServiceException(() -> jobService.createJob(request), JOB_CRON_EXPRESSION_INVALID);
    }
