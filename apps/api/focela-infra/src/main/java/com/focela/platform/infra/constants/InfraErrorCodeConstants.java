...
public interface InfraErrorCodeConstants {
    ...
    ErrorCode CONFIG_NOT_FOUND = new ErrorCode(1_001_000_001, "Config does not exist");
    ...
    ErrorCode JOB_NOT_FOUND = new ErrorCode(1_001_001_000, "Scheduled job does not exist");
    ...
    ErrorCode JOB_HANDLER_BEAN_NOT_FOUND = new ErrorCode(1_001_001_006, "Scheduled job handler Bean does not exist, note Bean name defaults to lowercase first letter");
    ...
    ErrorCode FILE_NOT_FOUND = new ErrorCode(1_001_003_001, "File does not exist");
    ...
    ErrorCode CODEGEN_TABLE_NOT_FOUND = new ErrorCode(1_001_004_004, "Table definition does not exist");
    ErrorCode CODEGEN_COLUMN_NOT_FOUND = new ErrorCode(1_001_004_005, "Column definition does not exist");
    ...
    ErrorCode CODEGEN_MASTER_TABLE_NOT_FOUND = new ErrorCode(1_001_004_010, "Master table (id={}) definition does not exist, please check");
    ErrorCode CODEGEN_SUB_COLUMN_NOT_FOUND = new ErrorCode(1_001_004_011, "Sub-table column (id={}) does not exist, please check");
    ...
    ErrorCode FILE_CONFIG_NOT_FOUND = new ErrorCode(1_001_006_000, "File config does not exist");
    ...
    ErrorCode DATA_SOURCE_CONFIG_NOT_FOUND = new ErrorCode(1_001_007_000, "Data source config does not exist");
    ...
    ErrorCode REFERENCE_CONTACT_NOT_FOUND = new ErrorCode(1_001_201_000, "Reference contact does not exist");
    ErrorCode REFERENCE_CATEGORY_NOT_FOUND = new ErrorCode(1_001_201_001, "Reference category does not exist");
    ErrorCode REFERENCE_CATEGORY_HAS_CHILDREN = new ErrorCode(1_001_201_002, "Child reference categories exist, cannot delete");
    ErrorCode REFERENCE_CATEGORY_PARENT_NOT_FOUND = new ErrorCode(1_001_201_003, "Parent reference category does not exist");
    ...
    ErrorCode REFERENCE_USER_NOT_FOUND = new ErrorCode(1_001_201_007, "Reference user does not exist");
    ErrorCode REFERENCE_COURSE_NOT_FOUND = new ErrorCode(1_001_201_008, "Reference course does not exist");
    ErrorCode REFERENCE_GRADE_NOT_FOUND = new ErrorCode(1_001_201_009, "Reference grade does not exist");
    ErrorCode REFERENCE_GRADE_EXISTS = new ErrorCode(1_001_201_010, "Reference grade already exists");

    // ========== Legacy aliases ==========
    @Deprecated
    ErrorCode CONFIG_NOT_EXISTS = CONFIG_NOT_FOUND;
    @Deprecated
    ErrorCode JOB_NOT_EXISTS = JOB_NOT_FOUND;
    @Deprecated
    ErrorCode JOB_HANDLER_BEAN_NOT_EXISTS = JOB_HANDLER_BEAN_NOT_FOUND;
    @Deprecated
    ErrorCode FILE_NOT_EXISTS = FILE_NOT_FOUND;
    @Deprecated
    ErrorCode CODEGEN_TABLE_NOT_EXISTS = CODEGEN_TABLE_NOT_FOUND;
    @Deprecated
    ErrorCode CODEGEN_COLUMN_NOT_EXISTS = CODEGEN_COLUMN_NOT_FOUND;
    @Deprecated
    ErrorCode CODEGEN_MASTER_TABLE_NOT_EXISTS = CODEGEN_MASTER_TABLE_NOT_FOUND;
    @Deprecated
    ErrorCode CODEGEN_SUB_COLUMN_NOT_EXISTS = CODEGEN_SUB_COLUMN_NOT_FOUND;
    @Deprecated
    ErrorCode FILE_CONFIG_NOT_EXISTS = FILE_CONFIG_NOT_FOUND;
    @Deprecated
    ErrorCode DATA_SOURCE_CONFIG_NOT_EXISTS = DATA_SOURCE_CONFIG_NOT_FOUND;
    @Deprecated
    ErrorCode REFERENCE_CONTACT_NOT_EXISTS = REFERENCE_CONTACT_NOT_FOUND;
    @Deprecated
    ErrorCode REFERENCE_CATEGORY_NOT_EXISTS = REFERENCE_CATEGORY_NOT_FOUND;
    @Deprecated
    ErrorCode REFERENCE_CATEGORY_PARENT_NOT_EXISTS = REFERENCE_CATEGORY_PARENT_NOT_FOUND;
    @Deprecated
    ErrorCode REFERENCE_USER_NOT_EXISTS = REFERENCE_USER_NOT_FOUND;
    @Deprecated
    ErrorCode REFERENCE_COURSE_NOT_EXISTS = REFERENCE_COURSE_NOT_FOUND;
    @Deprecated
    ErrorCode REFERENCE_GRADE_NOT_EXISTS = REFERENCE_GRADE_NOT_FOUND;
