package com.focela.platform.desensitize.core;
...
import com.focela.platform.desensitize.core.slider.annotation.BankCardDesensitize;
import com.focela.platform.desensitize.core.slider.annotation.CarLicenseDesensitize;
import com.focela.platform.desensitize.core.slider.annotation.ChineseNameDesensitize;
...
import com.focela.platform.desensitize.core.slider.annotation.MobileDesensitize;
import com.focela.platform.desensitize.core.slider.annotation.PasswordDesensitize;
import com.focela.platform.desensitize.core.slider.annotation.SliderDesensitize;
import lombok.Data;
...
public class DesensitizeTest {
    ...
    public void test() {
        ...
        desensitizeDemo.setRegex("你好，我是Focela Platform");
        desensitizeDemo.setAddress("北京市海淀区上地十街10号");
        desensitizeDemo.setOrigin("Focela Platform");
        ...
        assertEquals("Focela Platform", d.getOrigin());
    }
    ...
    public static class DesensitizeDemo {
        ...
        @RegexDesensitize(regex = "Focela Platform", replacer = "*")
