 ...
 *      1）Spring Async：
 *          {@link com.focela.platform.framework.quartz.config.FocelaAsyncAutoConfiguration#threadPoolTaskExecutorBeanPostProcessor()}
 *      2）Spring Security：
 *          TransmittableThreadLocalSecurityContextHolderStrategy
 *          和 FocelaSecurityAutoConfiguration#securityContextHolderMethodInvokingFactoryBean() 方法
 *
 */
