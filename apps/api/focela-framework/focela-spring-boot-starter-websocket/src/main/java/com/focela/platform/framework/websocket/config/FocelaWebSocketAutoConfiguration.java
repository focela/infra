...
import com.focela.platform.framework.mq.redis.config.FocelaRedisMQConsumerAutoConfiguration;
import com.focela.platform.framework.mq.redis.core.RedisMQTemplate;
import com.focela.platform.framework.websocket.core.handler.JsonWebSocketMessageHandler;
import com.focela.platform.framework.websocket.core.listener.WebSocketMessageListener;
import com.focela.platform.framework.websocket.core.security.LoginUserHandshakeInterceptor;
import com.focela.platform.framework.websocket.core.security.WebSocketAuthorizeRequestsCustomizer;
import com.focela.platform.framework.websocket.core.sender.kafka.KafkaWebSocketMessageConsumer;
import com.focela.platform.framework.websocket.core.sender.kafka.KafkaWebSocketMessageSender;
import com.focela.platform.framework.websocket.core.sender.local.LocalWebSocketMessageSender;
import com.focela.platform.framework.websocket.core.sender.rabbitmq.RabbitMQWebSocketMessageConsumer;
import com.focela.platform.framework.websocket.core.sender.rabbitmq.RabbitMQWebSocketMessageSender;
import com.focela.platform.framework.websocket.core.sender.redis.RedisWebSocketMessageConsumer;
import com.focela.platform.framework.websocket.core.sender.redis.RedisWebSocketMessageSender;
import com.focela.platform.framework.websocket.core.sender.rocketmq.RocketMQWebSocketMessageConsumer;
