package com.focela.platform.module.infra.framework.codegen.config;

import com.focela.platform.module.infra.enums.codegen.CodegenFrontTypeEnum;
import com.focela.platform.module.infra.enums.codegen.CodegenVOTypeEnum;
import lombok.Data;
...
@ConfigurationProperties(prefix = "focela.codegen")
@Validated
@Data
