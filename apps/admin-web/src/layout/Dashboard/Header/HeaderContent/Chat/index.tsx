...
] as Array<{ key: 'all' | 'unread' | 'favorites' | 'group'; label: string }>;
...
export default function Chat() {
  ...
  const [filter, setFilter] = useState<'all' | 'unread' | 'favorites' | 'group'>('all');
  const handleFilterChange = (value: 'all' | 'unread' | 'favorites' | 'group') => () => {
    setFilter(value);
  };
