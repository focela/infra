...
import { DataItem, workspaceData } from './data/workspace-data';
import { getImageUrl, ImagePath } from 'utils/getImageUrl';

// assets
import DownOutlined from '@ant-design/icons/DownOutlined';

const colors: Record<string, 'primary' | 'secondary' | 'warning' | 'default'> = {
  Free: 'default',
  Pro: 'primary'
};
...
function Label({ title, sx }: { title: string; sx?: SxProps }) {
...
export default function Workspace() {
  ...
  const onWorkspaceChange = (newValue: DataItem) => {
