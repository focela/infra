    ...
    if (variant === 'component') {
      return (
        <Stack sx={{ '& .header-link': { px: 2, '&:hover': { color: 'primary.main' } }, display: { xs: 'none', md: 'block' } }}>
          <Link className="header-link" color="white" component={RouterLink} to="/ai-prompts" underline="none">
            AI Prompts <AnimateSparkle triggered={true}>✨</AnimateSparkle>
          </Link>
    ...
    return (
      <Box sx={{ '& .header-link': { px: 2, '&:hover': { color: 'primary.main' } }, display: { xs: 'none', md: 'block' } }}>
        <Link
          ...
          color={pathname.includes('ai-prompts') ? 'primary' : 'white'}
    ...
    if (variant === 'component') {
      return (
        <Stack direction="row" sx={{ gap: 2, alignItems: 'center' }}>
          <Link underline="none" component={RouterLink} to="/ai-prompts" sx={{ color: 'white' }}>
    ...
    return (
      <Stack direction="row" sx={{ gap: 2, alignItems: 'center' }}>
        <Link
          ...
          component={RouterLink}
          to="/ai-prompts"
          sx={{ color: pathname.includes('ai-prompts') ? 'primary.main' : 'white' }}
        >
          <Stack direction="row" gap={1} alignItems="center">
            <Box component="span" sx={{ display: { xs: 'none', sm: 'block' } }}>
              AI Prompts
  ...
  const getDrawerContent = () => {
    ...
    return (
      <Drawer anchor="top" open={drawerToggle} onClose={drawerToggler(false)}>
        ...
        >
          <List>
            <Link underline="none" component={RouterLink} to="/ai-prompts">
              <ListItemButton selected={pathname.includes('ai-prompts')}>
                <ListItemIcon>
                  <LineOutlined />
                </ListItemIcon>
                <ListItemText
