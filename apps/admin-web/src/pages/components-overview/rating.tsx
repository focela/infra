          ...
          <Grid size={{ xs: 12, lg: 6 }}>
            <Stack sx={{ gap: 3 }}>
              ...
              <MainCard title="Precision" codeString={precisionRatingCodeString}>
                <Grid container spacing={1}>
                  <Grid size={12}>
                    <Rating name="half-rating" emptyIcon={<StarFilled />} defaultValue={3.6} precision={0.1} />
                  </Grid>
                  <Grid size={12}>
                    <Rating name="half-rating-read" emptyIcon={<StarFilled />} defaultValue={2.5} precision={0.5} readOnly />
                  </Grid>
                </Grid>
              </MainCard>
          ...
          <Grid size={{ xs: 12, lg: 6 }}>
            <Stack sx={{ gap: 3 }}>
              ...
              <MainCard title="Customization" codeString={customizationRatingCodeString}>
                <Grid container spacing={1}>
                  <Grid size={12}>
                    <Rating name="customized-10" emptyIcon={<StarFilled />} defaultValue={2} max={10} />
                  </Grid>
                  <Grid size={12}>
                    <Rating
                  ...
                  <Grid size={12}>
                    <Rating name="customized-color-smily" defaultValue={3} icon={<SmileOutlined />} emptyIcon={<SmileOutlined />} />
                  </Grid>
                </Grid>
              </MainCard>
