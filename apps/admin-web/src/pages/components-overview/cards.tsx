    ...
    <ComponentSkeleton>
      ...
      <ComponentWrapper>
        <Grid container spacing={3}>
          ...
          <Grid size={{ xs: 12, lg: 6 }}>
            <MainCard title="Amination Card" codeString={outlinedCardCodeString}>
              <Grid container spacing={3}>
                <Grid size={{ xs: 12, md: 6 }}>
                  <AnimateCard variants={{ visible: { opacity: 1 }, hidden: { opacity: 0 } }}>
                    <MainCard title="Fade" sx={{ height: '100%' }}>
                ...
                <Grid size={{ xs: 12, md: 6 }}>
                  <AnimateCard
                    style={{ height: '100%' }}
                    variants={{ hidden: { opacity: 0, translateY: 200 }, visible: { opacity: 1, translateY: 0 } }}
                  >
                    <MainCard title="Slide" sx={{ height: '100%' }}>
                      <Typography variant="h6">Animation</Typography>
                      <Typography variant="caption" color="text.secondary">
                        This is a card description
                      </Typography>
