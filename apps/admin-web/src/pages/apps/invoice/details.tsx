...
// material-ui
import { Theme, useColorScheme, useTheme, Palette, SupportedColorScheme } from '@mui/material/styles';
...
function PDFIconButton({ list, currentPalette, scheme }: { list: InvoiceList; currentPalette: Palette; scheme: SupportedColorScheme }) {
  return (
    <PDFDownloadLink
